...
@Component({
  selector: 'app-profile-legal-page',
  standalone: true,
  imports: [RouterLink, TranslatePipe, ErrorStateComponent],
  templateUrl: './profile-legal-page.html',
  styleUrl: './profile-legal-page.scss',
})
export class ProfileLegalPageComponent implements OnInit {
